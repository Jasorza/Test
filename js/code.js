...
//     var btnChechbox = document.getElementById('enviar');
//     btnChechbox.onclick = function () {
...
//              if (document.forms['formulario']['interes'].checked){

//              }else{
//                  alert('Debes de selecionar al menos uno');
//              }
//         }
//     }
// };
...
function validar() {
    ...
    if (!exp.test(document.getElementById('mail').value)) {
        datosCorrectos = false;
        error = alert("El Correo es invalido");
    ...
    if(isChecked){
        alert('Checkbox esta selecionado')
    }
